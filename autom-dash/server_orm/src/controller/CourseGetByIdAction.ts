 ...
 */
export async function courseGetByIdAction(request: Request, response: Response) {
    ...
    const course = await courseRepository.findOneBy({id: parseInt(request.params.id)});
