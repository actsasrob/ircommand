...
exports.courseGetByIdAction = void 0;
const typeorm_1 = require("typeorm");
const Course_1 = require("../entity/Course");
/**
 * Loads course by a given id.
 */
function courseGetByIdAction(request, response) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const course = yield courseRepository.findOneBy({ id: parseInt(request.params.id) });
...
exports.courseGetByIdAction = courseGetByIdAction;
//# sourceMappingURL=CourseGetByIdAction.js.map