...
export const REMOTE_DASHES: any = {
  ...
  3: {
    id: 3,
    description: 'RxJs In Practice RemoteDash',
  ...
  1: {
    id: 1,
    description: 'Serverless Angular with Firebase RemoteDash',
...
*/
  ...
  12: {
    id: 12,
    description: 'Angular Testing RemoteDash',
  ...
  6: {
    id: 6,
    description: 'Angular Security RemoteDash - Web Security Fundamentals',
  ...
  7: {
    id: 7,
    description: 'Angular PWA - Progressive Web Apps RemoteDash',
  ...
  9: {
    id: 9,
    description: 'The Complete Typescript RemoteDash',
  ...
  10: {
    id: 10,
    description: 'Rxjs and Reactive Patterns Angular Architecture RemoteDash',
  ...
  11: {
    id: 11,
    description: 'Angular Material RemoteDash',
...
export const LESSONS = {
  ...
  11: {
    id: 11,
    'description': 'RemoteDash Helicopter View',
    'duration': '08:19',
    'seqNo': 1,
    remoteDashId: 6
  },
  ...
  22: {
    id: 22,
    'description': 'RemoteDash Kick-Off - Install Node, NPM, IDE And Service Workers Section Code',
    'duration': '07:19',
    'seqNo': 1,
    remoteDashId: 7
  },
  ...
  // Serverless Angular with Firebase RemoteDash
  ...
  // Angular Testing RemoteDash

  40: {
    id: 40,
    description: 'Angular Testing RemoteDash - Helicopter View',
    'duration': '5:38',
    'seqNo': 1,
    remoteDashId: 12
  },
  ...
  50: {
    id: 50,
    "description": "Welcome to the Angular Ngrx RemoteDash",
    "duration": "6:53",
    "seqNo": 1,
    remoteDashId: 4
  ...
  51: {
    id: 51,
    "description": "The Angular Ngrx Architecture RemoteDash - Helicopter View",
    "duration": "5:52",
    "seqNo": 2,
    remoteDashId: 4
  },
...
export function findLessonsForRemoteDash(remoteDashId: number) {
